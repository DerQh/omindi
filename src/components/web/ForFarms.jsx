    ...
    <>
      ...
      <Hero>
        <HeroInner>
          ...
          <HeroTitle>Built for Farmers.<br />Designed to Sell.</HeroTitle>
          <HeroSub>
            List your fresh produce, farm products, and events for free.
            Connect with local buyers and grow your farm business on your own terms.
          </HeroSub>
          <HeroActions>
            <PrimaryBtn onClick={() => navigate("/sign-up")}>Start Selling Free</PrimaryBtn>
            <OutlineBtn onClick={() => navigate("/pricing")}>See Pricing</OutlineBtn>
          </HeroActions>
          <HeroNote>No credit card required · 3 free listings to start</HeroNote>
        </HeroInner>
      </Hero>
      ...
      <CtaBanner>
        ...
        <PrimaryBtn onClick={() => navigate("/sign-up")}>Set Up Your Listing</PrimaryBtn>
      </CtaBanner>
...
const HeroNote = styled.p`
  margin: 18px 0 0; font-size: 0.8rem;
...
`;
const Inner = styled.div`max-width: 1080px; margin: 0 auto;`;
...
const SectionTitle = styled.h2`
  ...
  color: #1a3318; letter-spacing: -0.3px; margin: 0 0 14px;
`;
...
const StepNum = styled.div`
  font-size: 2.5rem; font-weight: 800; color: #d1fae5;
  line-height: 1; margin-bottom: 16px;
`;
const StepTitle = styled.h3`
  font-size: 1.05rem; font-weight: 800; color: #1a3318; margin: 0 0 10px;
`;
const StepText = styled.p`
  font-size: 0.9rem; color: #6b7280; line-height: 1.7; margin: 0;
`;

const ImageSection = styled.div`background: #f5f8f5; padding: 0;`;
...
const FeatureCard = styled.div`
  ...
  &:hover { transform: translateY(-3px); box-shadow: 0 8px 24px rgba(20,57,32,0.1); }
`;
const FeatureIcon = styled.div`font-size: 1.8rem; margin-bottom: 14px;`;
const FeatureTitle = styled.h3`
  font-size: 0.97rem; font-weight: 800; color: #1a3318; margin: 0 0 8px;
`;
const FeatureText = styled.p`
  font-size: 0.87rem; color: #6b7280; line-height: 1.7; margin: 0;
`;
...
const LocalSub = styled.p`
  font-size: 0.97rem; color: #4b5563; line-height: 1.8; margin: 0;
`;
...
const CtaSub = styled.p`
  color: rgba(255,255,255,0.72); font-size: 1rem; margin: 0 0 32px;
`;
